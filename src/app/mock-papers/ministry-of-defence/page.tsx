...
export function generateMetadata(): Metadata {
  return buildPageMetadata({
    ...
    description: 'Free 100-Question Ministry of Defence (MOD) Written Test practice paper. Aligned to past papers syllabus: English (20%), Pakistan Studies (20%), Islamiat (15%), General Knowledge & Current Affairs (15%), Everyday Science (15%), Mathematics (15%). Live 90-min timer & instant grading.',
    path: '/mock-papers/ministry-of-defence',
    ...
    keywords: [
      ...
      'MOD Solved MCQs Practice Set',
      'Pak Defence Ministry Exam'
    ],
  });
}

export default function MinistryOfDefenceMockPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-6">
      <div className="max-w-5xl mx-auto px-4 space-y-6">
        ...
        {/* Interactive 100-Question MOD Mock Test Component */}
