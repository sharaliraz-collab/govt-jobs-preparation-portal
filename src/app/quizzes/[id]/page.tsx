...
export default function QuizAttemptPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Header Bar */}
      <div className="bg-white p-5 rounded-xl border border-govt-border shadow-sm flex items-center justify-between gap-4">
        <div>
      ...
      {/* RESULT BREAKDOWN VIEW (IF SUBMITTED) */}
      {result ? (
