        ...
        <div className="bg-gradient-to-r from-emerald-950 via-teal-900 to-emerald-950 text-white rounded-2xl p-6 sm:p-7 shadow-md border border-emerald-800 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <button
                onClick={handlePrint}
                className="bg-yellow-400 hover:bg-yellow-300 text-emerald-950 text-xs font-extrabold px-3.5 py-2 rounded-xl transition shadow-sm flex items-center gap-1.5 no-print"
                title="Print test paper or save as PDF"
              >
              ...
              {examStarted && !examSubmitted && selectedTimer > 0 && (
                <div className={`px-4 py-2.5 rounded-xl border text-center font-mono shadow-sm ${
